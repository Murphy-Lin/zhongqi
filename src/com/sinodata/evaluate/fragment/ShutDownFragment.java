	...
	public View onCreateView(LayoutInflater inflater,
		...
		btn_shutdown.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				new AlertDialog.Builder(MyApplication.getContext()).setTitle("您确认是否关机么？").setPositiveButton("关机", new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						try {
							...
							proc.waitFor();
							Toast.makeText(MyApplication.getContext(), "自动关机", Toast.LENGTH_SHORT).show();
						} catch (Exception e) {
